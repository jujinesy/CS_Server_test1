...
namespace SimpleHttp
{
    ...
    public class Works
    {
        ...
        public Works()
        { }
        //public Works(Point scn, string content)
        public Works(Coordinate scn, string content)
        {
            piX = scn.X;
            piY = scn.Y;
            cont = content;
    ...
    public class ThreadPoolQueue
    {
        ...
        public static ThreadPoolQueue Instance { get { return Nested.instance; } }
        ...
        private class Nested
        {
            ...
            internal static readonly ThreadPoolQueue instance = new ThreadPoolQueue();
        }
    ...
    public class ThreadPool
    {
        ...
        public static ThreadPool Instance { get { return Nested.instance; } }
        ...
        private class Nested
        {
            ...
            internal static readonly ThreadPool instance = new ThreadPool();
        }
        ...
        internal enum KeybdEventFlags : uint
        {
            ...
            A = 0x41, //A Control key code
            C = 0x43 //A Control key code
        }
        ...
        public void ThreadPoolRun()
        {
            ...
            //th1.Start();
            Start.TellerLine.Clear();
            while (bThreadPool)
            {
                while (Start.TellerLine.Count != 0)
                {
                    Works nextInLine = new Works();
                    nextInLine = (Works)Start.TellerLine.Dequeue();



                    uint x = (uint)(nextInLine.X * 65535 / System.Windows.Forms.Screen.PrimaryScreen.Bounds.Width);
                    uint y = (uint)(nextInLine.Y * 65535 / System.Windows.Forms.Screen.PrimaryScreen.Bounds.Height);
                    mouse_event((uint)MouseEventFlags.ABSOLUTE | (uint)MouseEventFlags.MOVE, x, y, 0, 0);
                    mouse_event((uint)MouseEventFlags.LEFTDOWN, 0, 0, 0, 0);
                    mouse_event((uint)MouseEventFlags.LEFTUP, 0, 0, 0, 0);

                    System.Windows.Forms.Clipboard.SetText(nextInLine.content);

                    keybd_event((byte)VirtualKeyShort.LCONTROL, (byte)ScanCodeShort.LCONTROL, (int)KeybdEventFlags.KEYEVENTF_EXTENDEDKEY | 0, 0); //키보드를 누른 상태 나...
                    keybd_event((byte)VirtualKeyShort.KEY_V, (byte)ScanCodeShort.KEY_V, (int)KeybdEventFlags.KEYEVENTF_EXTENDEDKEY | 0, 0); //키보드를 누른 상태 나...
                    keybd_event((byte)VirtualKeyShort.KEY_V, (byte)ScanCodeShort.KEY_V, (int)KeybdEventFlags.KEYEVENTF_EXTENDEDKEY | (int)KeybdEventFlags.KEYEVENTF_KEYUP, 0);
                    keybd_event((byte)VirtualKeyShort.LCONTROL, (byte)ScanCodeShort.LCONTROL, (int)KeybdEventFlags.KEYEVENTF_EXTENDEDKEY | (int)KeybdEventFlags.KEYEVENTF_KEYUP, 0);

                    Thread.Sleep(200);                    
                    keybd_event((byte)VirtualKeyShort.ENTER, (byte)ScanCodeShort.ENTER, (int)KeybdEventFlags.KEYEVENTF_EXTENDEDKEY | 0, 0); //키보드를 누른 상태 나...
                    keybd_event((byte)VirtualKeyShort.ENTER, (byte)ScanCodeShort.ENTER, (int)KeybdEventFlags.KEYEVENTF_EXTENDEDKEY | (int)KeybdEventFlags.KEYEVENTF_KEYUP, 0);

                    Console.WriteLine("after :" + Start.TellerLine.Count.ToString());
                    Thread.Sleep(1000);
        ...
        public void Start()
        {
            tpr = new Thread(new ThreadStart(ThreadPoolRun));
            tpr.SetApartmentState(ApartmentState.STA);
